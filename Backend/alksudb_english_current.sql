...
--
-- Table structure for table `english_current`
--
...
CREATE TABLE `english_current` (
  ...
  `key_modified` bit(1) NOT NULL,
  `key_name` varchar(255) NOT NULL,
  `key_new` bit(1) NOT NULL,
  `key_note` varchar(1000) DEFAULT NULL,
...
--
-- Dumping data for table `english_current`
--

LOCK TABLES `english_current` WRITE;
/*!40000 ALTER TABLE `english_current` DISABLE KEYS */;
/*!40000 ALTER TABLE `english_current` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-10-11 12:37:06
